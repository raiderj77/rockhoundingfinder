      ...
      <head>
        ...
        {!gpcHeader && (
          <>
            ...
            <Script src="https://www.googletagmanager.com/gtag/js?id=G-SZ9KGE17K5" strategy="afterInteractive" />
            <Script id="google-analytics" strategy="afterInteractive">
              {`window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-SZ9KGE17K5');`}
            </Script>
          </>
        )}
